  ...
  return (
    <div className="bg-white flex flex-col items-center justify-center mx-auto mt-10 max-w-[1300px] h-[600px]">
      ...
      <div className="w-full text-center md:text-left mb-6">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900">End-to-End</h1>
        <div className="w-[300px] border-b-4 border-dotted border-orange-400 mt-2 mx-auto md:mx-0"></div>
      </div>

      {/* Background Image */}
      <div className="absolute w-[400px] opacity-5 filter grayscale mt-[4650px]" style={{ top: "100px", left: "900px", zIndex: 1 }}>
      ...
      <div className="flex w-full items-center justify-between mt-10">
        {/* Services Grid */}
        <div className={`${isMobile ? "grid grid-cols-2 gap-x-6 gap-y-8" : isTablet ? "grid grid-cols-3 gap-x-6 gap-y-8 w-full" : "grid grid-cols-3 gap-x-14 gap-y-40 w-4/5"} text-center`}>
        ...
        <div className="w-1/2 flex justify-center items-center">
          <img src="/Servicepic/Cloud/Uploading-amico 1.png" alt="Cloud Enablement" className="w-full h-auto max-w-full object-contain -mt-[100px]" />
        </div>
      </div>
    </div>
  );
